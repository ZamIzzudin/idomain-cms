...
import { useTestimonialDetail, useUpdateTestimonial } from "../../hook";
...
export default function EditTestimonialPage() {
  ...
  const { data: item, isLoading } = useTestimonialDetail(id);
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-xl font-bold text-slate-800 flex items-center gap-2">
            <Quote className="w-3 h-3 text-primary-600" /> Edit Testimonial
          </h1>
