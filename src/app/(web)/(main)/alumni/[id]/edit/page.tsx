...
export default function EditAlumniPage() {
  ...
  const handleSubmit = () => {
    ...
    updateAlumni(
      ...
      {
        onSuccess: () => {
          Notification("success", "Alumni updated successfully");
          router.push("/alumni");
        },
        onError: (error: any) => {
          Notification("error", error.message || "Failed to update alumni");
        },
      },
    );
  };
    ...
    <div className="max-w-full mx-auto">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-slate-500 text-sm">Update alumni information</p>
        </div>
      </div>
